...
using static QingNing.Swagger.CustomApiVersion;

namespace QingNing.Swagger;
/// <summary>
/// Swagger 启动服务
/// </summary>
public static class SwaggerSetup
{
    public static void AddSwaggerSetup(this IServiceCollection services)
    {
        ...
        var ApiName = App.Configuration.GetSection("Startup:ApiName").Value;
        ...
        services.AddSwaggerGen(c =>
        {
            ...
            //            {
            //                AuthorizationUrl = new Uri($"{App.Configuration.GetSection("Startup:IdentityServer4:AuthorizationUrl")}/connect/authorize"),
